...
// writable over HTTP. Phone and desktop deliberately share the same values.
'use strict';
...
const DEFAULTS = {
  ...
  // the pane's interactive shell, so aliases and flags still work.
  agentCommand: 'codex',
  // Prefill for the new-session directory field.
  defaultCwd: '',
  // Explicit Tailscale MagicDNS names or ordinary OpenSSH targets mirrored
  // into the local Herdr sidebar. Never discovered automatically.
  remoteHosts: [],
};
