...
Every clip has its own page with an explanation of what you are seeing and how
it works. All were recorded on a real Android emulator driving the app over
HTTPS, or on desktop Chromium; videos are hosted as GitHub attachments
([#3](https://github.com/eyalev/herdr-web/issues/3)).
